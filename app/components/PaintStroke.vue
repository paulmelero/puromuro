...
const strokeVariants = [
  {
    ...
    overlay:
      'M8,4.5 C22,3.2 40,2.5 65,3.5 C85,4.2 105,2.8 125,3.8 C145,4.5 165,3 185,3.8 L194,4 L192,8.5 C172,9.5 152,8 132,9 C112,9.8 92,8.2 72,9 C52,9.6 32,8.2 14,9 L6,8.5 Z',
  },
  {
    ...
    overlay:
      'M10,4 C30,2.8 50,3.8 75,3 C95,2.5 115,4 135,3.2 C155,2.5 175,4 190,3.5 L193,4.2 L190,9 C170,10 150,8.5 130,9.5 C110,10.2 90,8.8 70,9.5 C50,10 30,8.8 12,9.5 L8,9 Z',
  },
  {
    ...
    overlay:
      'M5,4 C20,3 38,2.5 58,3.5 C78,4.2 98,3 118,3.8 C138,4.3 160,3 180,4 L195,3.5 L192,8.8 C175,9.5 155,8.5 135,9.2 C115,9.8 95,8.5 75,9.2 C55,9.8 35,8.5 15,9.5 L3,9 Z',
  },
];
