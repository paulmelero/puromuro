    ...
    <div class="px-6 md:px-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0">
        ...
        <div class="lg:col-span-5 lg:pr-16">
          <h2
            class="font-heading text-4xl md:text-6xl lg:text-7xl font-black text-warm-white leading-[0.9] mb-8"
          >
            HABLEMOS
          </h2>
          <PaintStroke
        ...
        <div class="lg:col-span-6 lg:col-start-7">
          ...
          >
            <p
              class="font-heading text-sm font-bold tracking-[0.1em] text-warm-white uppercase"
            >
          ...
          <div v-if="status === 'error'" class="border-2 border-brick p-6 mb-8">
            <p
              class="font-heading text-sm font-bold tracking-[0.1em] text-brick uppercase"
            >
              Error
            </p>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-8">
            <div>
              <label
                for="nombre"
                class="label-mono text-warm-white/40 block mb-3"
                >Nombre *</label
              >
              <input
                id="nombre"
